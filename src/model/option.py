...
parser.add_argument('--data_dir', type=str, default='D:\Projects\jiaomo-3classier\Image2',
                    help='data directory')


parser.add_argument('--h5dir', type=str, default='/hdf5_0.7_299x299', help='hdf5储存位置')
...
parser.add_argument('--save', type=str, default='D:\Projects\jiaomo-3classier\model2/inception_2_1/',
...
parser.add_argument('--early_stopping', type=int, default=300, help='patience')
parser.add_argument('--lr', type=float, default=1e-4, help='learning rate')
parser.add_argument('--online', type=bool, default=False, help='training online')
parser.add_argument('--batch_size', type=int, default=25, help='')  # Res_net:13 #mobile nas:13 //inception v3 30
